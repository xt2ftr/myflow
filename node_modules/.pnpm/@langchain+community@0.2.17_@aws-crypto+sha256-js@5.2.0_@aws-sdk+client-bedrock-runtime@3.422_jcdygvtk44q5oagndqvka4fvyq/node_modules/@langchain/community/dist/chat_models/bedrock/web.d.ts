...
export declare class BedrockChat extends BaseChatModel<BedrockChatCallOptions, AIMessageChunk> implements BaseBedrockInput {
    ...
    _combineLLMOutput(): {};
    bindTools(tools: (StructuredToolInterface | AnthropicTool | ToolDefinition)[], _kwargs?: Partial<this["ParsedCallOptions"]>): Runnable<BaseLanguageModelInput, BaseMessageChunk, this["ParsedCallOptions"]>;
}
/**
