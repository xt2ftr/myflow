    ...
    constructor(configOrAddress, ssl, username, password, channelOptions) {
        ...
        switch (this.tlsMode) {
            case __1.TLS_MODE.ONE_WAY:
                ...
                const sslOption = ((_b = this.config.tls) === null || _b === void 0 ? void 0 : _b.rootCertPath)
                    ? (0, fs_1.readFileSync)((_c = this.config.tls) === null || _c === void 0 ? void 0 : _c.rootCertPath)
                    : undefined;
            ...
            case __1.TLS_MODE.TWO_WAY:
                ...
                const rootCertBuff = rootCertPath
                    ? (0, fs_1.readFileSync)(rootCertPath)
                    : null;
                const privateKeyBuff = privateKeyPath
                    ? (0, fs_1.readFileSync)(privateKeyPath)
                    : null;
                const certChainBuff = certChainPath
