...
class HuggingFaceInferenceAPI extends _base.BaseLLM {
    static{
    ...
    async *streamChat(params) {
        ...
        yield* (0, _utils.streamConverter)(stream, (chunk)=>({
...
class HuggingFaceLLM extends _base.BaseLLM {
    static{
    ...
    async getModel() {
        const { AutoModelForCausalLM } = await (0, _transformers.lazyLoadTransformers)();
        if (!this.model) {
